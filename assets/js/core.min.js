...
var Mi = {
    ...
    Basic: {
        init: function() {
            ...
            }), e.mobileDetector(), e.backgrounds(), e.scroller(), e.masonry(), e.ajaxLoader(), e.mobileNav(), e.forms()
        },
            ...
            o.validate({
                ...
                messages: {
                    name: {
                        ...
                        minlength: "Votre nom doit être composé d'un caractère."
                    },
                    email: {
                        required: "Veuillez entrer votre adresse e-mail.",
                        minlength: "Votre adresse email est incorrecte."
                    },
                    message: {
                        required: "Veuillez écrire un message.",
                        minlength: "Votre message doit dépasser 10 caractères."
                    }
                }
            }), o.submit(function() {
                ...
                return e.hide().html(), o.valid() ? ($.ajax({
                    ...
                    success: function(data) {
                        if(data.status == 'success'){
                            a = '<div class="alert alert-success">C&acute;est fait ! Merci pour votre message. <br>Je vous répondrai aussi vite que possible.';
                        }else if(data.status == 'error'){
                            a = '<div class="alert alert-danger">Ooops... On dirait qu&acute;une erreur s&acute;est produite.';
                        }
                        e.html(a), e.show();
                    },
                }), !1) : !1
    ...
    Components: {
        init: function() {
            // this.carousel(), this.modal(),
            //     this.chart(),
                    this.progressBar(), this.tooltip(), this.popover(), this.messenger()
                // , this.videoPlayer()
                , this.navToggleable(), this.navFilter()
        },
        // modal: function() {
